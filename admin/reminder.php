...
$(document).ready(function(){
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
        ...
        <div class="app-title">
        <div>
          <h1><i class="fa fa-map-marker" aria-hidden="true"></i> Adding New Tour Package</h1>
...
<input class="btn btn-success" type="submit" id="package_btn" value="Add" name="sub"/>
...
<div class="row">
    ...
    <div class="tile">
    	...
    	<div class="form-group">
 		...
 		<input type="text" id="package" name="package" class="form-control" placeholder="Search here....">
