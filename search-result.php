...
<body>
  ...
  <section class="inner-page-banner bg_img overlay-3" data-background="assets/images/inner-page-bg.jpg">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2 class="page-title">Indian Tour Packages</h2>
          <ol class="page-list">
  ...
  <section class="car-search-section pt-120 pb-120">
    ...
    ?>             <a href="packages.php?category=<?php echo $data['name'];?>">
                  ...
                  <div class="col-lg-7 col-md-7 col-sm-6 d-flex">
                    ...
                    <input class="search-submit-btn" name="user_data" type="submit">
...
else
{
    ...
    $query="SELECT * FROM `package_tours` WHERE package='India' ORDER BY id DESC LIMIT $limitFrom,4";
        search($query);
            ...
            <!-- car-item end -->
           <?php
                  $sel1="SELECT * FROM `package_tours` WHERE package='India'";
                     ...
                     for($i=1;$i<=$count;$i++)
                  {
                     ?>
                      ...
                      <li class="page-item active">
                        <a class="page-link" href="indian-tour-package.php?page=<?php echo $i ?>"><?php echo $i?></a>
                      </li>
